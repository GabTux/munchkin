...
_OBJ      = game/GameObject.o game/cards/Card.o game/Player.o scene/Stop.o scene/Start.o scene/Menu/MenuButton.o scene/Menu/MenuSelector.o scene/Menu/Menu.o scene/Menu/MainMenu.o scene/Menu/GameMenu.o scene/SDLResources.o scene/SoloGame/SoloGame.o scene/SceneManager.o scene/Scene.o scene/Background.o main.o
OBJDIR    = obj
SRCDIR    = src
